...
To preserve the intrinsic geometric structure, ensuring that connected nodes remain close in the feature space, we introduce a graph regularization term,
\begin{align}
